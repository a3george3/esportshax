document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch(`/team/${encodeURIComponent(teamName)}/players`)
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      teamNameElement.innerText = `${team.team_name} ALL-TIME`;
      teamLogoElement.src = team.logo; // Setează src-ul pentru logo
      teamLogoElement.alt = `Logo of ${team.team_name}`;
      teamSeasonElement.innerText = `Founded in ${team.founded_season}`;
      ...
      document
        ...
        .querySelector(".stat-value").innerHTML = `
          <a href="/profile.html?id=${topScorer.id}" class="playerLink">
           <div class="playerDiv">  
      ...
      document
        ...
        .querySelector(".stat-value").innerHTML = `
          <a href="/profile.html?id=${topAssister.id}" class="playerLink">
            <div class="playerDiv">
      ...
      document
        ...
        .querySelector(".stat-value").innerHTML = `
          <a href="/profile.html?id=${mostMatches.id}" class="playerLink">
            <div class="playerDiv">
      ...
      document
        ...
        .querySelector(".stat-value").innerHTML = `
          <a href="/profile.html?id=${topCleanSheets.id}" class="playerLink">
          <div class="playerDiv"> 
  ...
  if (viewPlayersButton) {
    viewPlayersButton.addEventListener("click", () => {
      const teamName = params.get("teamName");
      if (teamName) {
        window.location.href = `/team.html?teamName=${encodeURIComponent(
          teamName
        )}`;
      }
    });
